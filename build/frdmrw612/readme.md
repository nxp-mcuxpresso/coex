...
```bash
$ cd mcu-sdk-3.0
$ west build -b frdmrw612 examples/src/coex_examples/coex_wifi_edgefast --toolchain armgcc --config=flash_debug -d coex_wifi_edgefast
```
> flash_release
```bash
$ cd mcu-sdk-3.0
$ west build -b frdmrw612 examples/src/coex_examples/coex_wifi_edgefast --toolchain armgcc --config=flash_release -d coex_wifi_edgefast
```
